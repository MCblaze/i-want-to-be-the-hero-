...
| AN-10 | Medium | User observed Logan running in place on station 3's teal moving platform. Live capture: hero and platform both moved at -1.34 units/s with no movement input, yet the clip was run. | Ground locomotion now selects and scales its animation from velocity relative to the supporting platform. See [platform follow-up evidence](evidence/animations/platform-carry/README.md). |
